...
<body style="background-color: #efefef" onload="process()">
    ...
    <header>
        <div class="navbar fixed-top">
            <div class="container">
                <div class="navtitle">Controlo do ESP8266</div>
    ...
    <main class="container" style="margin-top:70px">
        <div class="flex-container">
            ...
            <div class="flex-child green">
                <div class="category">Saídas Analógicas (PWM)</div>
                <br>
                <div class="bodytext">LED verde PWM slider</div>
                <br>
        ...
        <div class="flex-container">
            <div class="flex-child magenta">
                <div class="category">Entradas Digitais</div>
                <br>
                <div class="bodytext">Botão de pressão</div>
                <button type="button" class="btn_input" id="btn_input" disabled>Toggle</button>
                <br>
                <br>
                <div class="bodytext">Botão flash</div>
            ...
            <div class="flex-child green">
                <div class="category">Entradas Analógicas</div>
                <br>
                <div style="border-radius: 10px !important;">
                    <table style="width:50%">
                        ...
                        <tr>
                            <td>
                                <div class="bodytext">Sensor de luminusidade</div>
                            </td>
                            <td>
